...
#define MFRC522_CS_RCC_EN()     GPIOB_PCLK_EN() //RCC_APB2Periph_GPIOB
#define MFRC522_CS_RCC_DI()     GPIOB_PCLK_DI()

#define MFRC522_RST_RCC_EN()        GPIOB_PCLK_EN() //RCC_APB2Periph_GPIOB
#define MFRC522_RST_RCC_DI()        GPIOB_PCLK_DI()
